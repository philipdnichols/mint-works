...
export function AiTurnModal({ entries, open, title, onClose }: AiTurnModalProps) {
      ...
      >
        <header className="modal__header">
          <div>
            ...
            <p className="modal__subtitle">Progress report from the AI turn.</p>
          </div>
        ...
        <div className="modal__body">
          {entries.length === 0 ? (
            <p className="muted">No AI actions recorded.</p>
          ) : (
